...
static void update_rotations(t_transformation_stack *t)
{
...
static void update_translation_and_scale(t_transformation_stack *t)
{
    if (t->dirty[M_SCALE])
    {
...
static void    recompute_final_transformation(t_transformation_stack *t)
{
    float   *pingpong[2];
    size_t  i;
...
void	transformation_stack_update(t_transformation_stack *t)
{
    ...
    update_rotations(t);
    update_translation_and_scale(t);
    should_update = false;
    i = 0;
    while (i < M_COUNT)
    {
